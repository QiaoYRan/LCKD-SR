...
from models.DistillSRS_T import Distill_SASRec_T
...
class Trainer(object):
    ...
    def _create_model(self):
        ...
        elif self.args.model_name == "dt_llm_sasrec":
            self.model = Distill_SASRec_T(self.user_num, self.item_num, self.device, self.args)
